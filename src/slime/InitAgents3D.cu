...
__global__ void InitAgentsKernel(Agent* Agents, mesh::Vertex* Verts, mesh::Triangle* Tris, float* TrailMap,
...
void slime::SlimeSim3D::LaunchInitAgentsKernel()
{
    ...
    InitAgentsKernel<<<gSize, bSize>>>(dAgents, dVerts, dTris, dTrailMap, TrailMapTex.Width, TrailMapTex.Height, Params);
